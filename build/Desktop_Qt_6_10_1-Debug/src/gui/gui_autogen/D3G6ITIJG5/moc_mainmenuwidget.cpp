...
#include "../../../../../../src/gui/blocks/mainmenuwidget.h"
...
void MainMenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->intervalClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MainMenuWidget::*)()>(_a, &MainMenuWidget::intervalClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void MainMenuWidget::intervalClicked()
{
